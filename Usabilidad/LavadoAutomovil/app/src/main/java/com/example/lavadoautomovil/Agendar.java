    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btmapa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String spin2;
                String tipos;
                spin = spinner.getSelectedItem().toString().trim();
                //spin2 = edtfecha.getText().toString().trim();
                tipos = spinnerCountries.getSelectedItem().trim();
                Bundle extras = new Bundle();
                extras.putString("Hora", spin);
                extras.putString("Tipo Lavado", tipos);
                //extras
                    Intent intent = new Intent(Agendar.this, Confirmacion.class);
